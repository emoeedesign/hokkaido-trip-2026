export const initialTripData = {
  ...
  accommodation: {
    ...
    address:
      "〒064-0912 北海道札幌市中央区南１２条西８丁目１−２４ 第３７松井ビル",
  ...
  saunas: [
    {
      name: "定山渓温泉 湯の花（日帰り専門）",
      feature:
        "有名熱波師監修！オートロウリュ1時間に3回\n源泉100%の水風呂、開放的な外気浴",
      price: "¥980",
      hours: "10:00〜21:00 ／ 駐車場400台",
    },
    {
      name: "定山渓万世閣ホテルミリオーネ",
      feature:
        "2024年リニューアル！8分毎オートロウリュ\n水深1.1mの水風呂、外気浴インフィニティチェア",
      price: "¥1,200〜1,500",
      hours: "7:00〜10:00 / 12:00〜20:00",
    },
    {
      name: "定山渓 鹿の湯",
      feature:
        "4段スタジアム型サウナ！20分毎オートロウリュ\n豊平川源流の沢水かけ流し水風呂（8〜9℃＆15〜17℃）",
      price: "¥1,500",
      hours: "13:00〜 ／ 日帰り入浴OK",
    },
  ],
